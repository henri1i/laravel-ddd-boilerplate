...
namespace Main\Core\Classes;

use FilesystemIterator;
use Main\Core\Contracts\DomainInterface;
use Main\Core\DTO\DomainDTO;
use Main\Core\Exceptions\DomainNotExistsException;
use Main\Core\Exceptions\DomainExtendException;
use Main\Core\Traits\Singleton;
